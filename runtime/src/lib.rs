...
impl WeightToFeePolynomial for WeightToFee {
	...
	fn polynomial() -> WeightToFeeCoefficients<Self::Balance> {
		...
		// in Thippy, we map to 1/10 of that, or 1/10 MILLIUNIT
		let p = MILLIUNIT / 10;
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("thippy"),
	impl_name: create_runtime_str!("thippy"),
	authoring_version: 1,
	spec_version: 15,
	impl_version: 1,
	apis: RUNTIME_API_VERSIONS,
	transaction_version: 1,
	// Since Thippy is a "live" chain (on Rococo anyways), we need to set this to `0` until a
	// migration path to `state_version = 1` is ready.
	//
	// See the following PRs for more details:
	// - https://github.com/ng8eke/substrate/pull/9732
	// - https://github.com/ng8eke/substrate/pull/10073
	state_version: 0,
};
...
impl pallet_contracts_rpc_runtime_api::ContractsApi<Block, AccountId, Balance, BlockNumber, Hash>
	...
	impl frame_try_runtime::TryRuntime<Block> for Runtime {
		fn on_runtime_upgrade() -> (Weight, Weight) {
			log::info!("try-runtime::on_runtime_upgrade thippy-parachain");
