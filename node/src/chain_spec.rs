...
use thippy_runtime::{AccountId, AuraId, Signature};
...
pub fn local_testnet_config(id: ParaId) -> ChainSpec {
	...
	ChainSpec::from_genesis(
		...
		ChainType::Local,
		move || {
			// TODO [#76]: Right now these are being left as default values, but in the old `thippy-node`
...
fn testnet_genesis(
	...
	thippy_runtime::GenesisConfig {
		...
		sudo: thippy_runtime::SudoConfig { key: root_key },
		parachain_info: thippy_runtime::ParachainInfoConfig { parachain_id: id },
		aura: thippy_runtime::AuraConfig { authorities: initial_authorities },
