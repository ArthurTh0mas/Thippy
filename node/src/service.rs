...
use thippy_runtime::{self, opaque::Block, RuntimeApi};
...
macro_rules! new_full_start {
	($config:expr) => {{
		...
		let builder = sc_service::ServiceBuilder::new_full::<
			thippy_runtime::opaque::Block, thippy_runtime::RuntimeApi, crate::service::Executor
		>($config)?
